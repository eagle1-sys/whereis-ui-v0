...
// The home page is fully static (the only interactivity is the external
// /submit.js script + plain form), so render it to HTML at build time.
export const config = {
  prerender: true,
};
          ...
          <div class="relative">
            <div class="space-y-6">
              ...
              >
                ...
                <p id="validation-error" class="text-red-500 text-sm hidden">
                </p>
              </form>
            </div>
          </div>
